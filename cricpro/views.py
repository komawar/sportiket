...
def index(request):
    """View method for 'cricpro' app front page.
...
def teams_index(request):
    """View method for 'cricpro' app's teams' list page.
...
def teams_detail(request, team_id):
    """View method for 'cricpro' app's teams' details page.
...
def players_index(request):
    """View method for 'cricpro' app's players' list page.
...
def players_detail(request, player_id):
    """View method for 'cricpro' app's players' details page.
...
def matches_create(request):
    """View method for 'cricpro' app's matches' creation page.
...
def matches_fixtures_create(request):
    """View method for 'cricpro' app's tournament fixtures' creation page.
...
def matches_detail(request, match_id):
    """View method for 'cricpro' app's matches' details page.
